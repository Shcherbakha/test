...
$column_count = 7;
//Get count of full fill rows
$row_count = ceil($array_count / $column_count);
$row_number = 0;
$cell_number = 0;
$table = '<table style="border:1px solid #000;">
           <thead>
            <tr>
             <td colspan="' . $column_count . '" style="text-align: center;">' . $column_count . ' колонок</td>
            </tr>
           </thead>
          <tbody>';
//Draw a table
